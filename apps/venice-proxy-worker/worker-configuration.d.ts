/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=wrangler-types.vars --env-interface=CloudflareEnv` (hash: f7d059d5d63e4329f96d4a528137cdad)
...
interface __BaseEnv_CloudflareEnv {
	...
	ALLOWED_ORIGINS: "https://alicebtc.com,https://app.alicebtc.com,https://wallet.alicebtc.com,https://mutinynet.alicebtc.com,https://mainnet-alice-wallet.vercel.app,tauri://localhost,http://localhost:3000,http://127.0.0.1:3000,http://localhost:3002,http://localhost:8100";
	...
	PAID_CLOUD_MODELS: "e2ee-gpt-oss-120b-p";
	PAID_CLOUD_MAX_TOKENS: "8192";
	PAID_CLOUD_MAX_REQUEST_BYTES: "524288";
	PLAN_CLOUD_PRICE_CENTS: "500";
	PLAN_INPUT_TOKENS: "8000000";
	PLAN_OUTPUT_TOKENS: "2000000";
	BYTES_PER_TOKEN: "3.7";
	BILLING_CURRENCY: "EUR";
	SAT_PRICE_STEP: "100";
	BTCPAY_BASE_URL: "https://btcpay.alicebtc.com";
	BTCPAY_STORE_ID: "";
	BILLING_RETURN_URL: "https://app.alicebtc.com/?settings=account";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "AUTH_EMAIL_FROM" | "AUTH_EMAIL_PROVIDER" | "FREE_CLOUD_MODELS" | "FREE_CLOUD_MAX_TOKENS" | "FREE_CLOUD_MAX_REQUEST_BYTES" | "PAID_CLOUD_MODELS" | "PAID_CLOUD_MAX_TOKENS" | "PAID_CLOUD_MAX_REQUEST_BYTES" | "PLAN_CLOUD_PRICE_CENTS" | "PLAN_INPUT_TOKENS" | "PLAN_OUTPUT_TOKENS" | "BYTES_PER_TOKEN" | "BILLING_CURRENCY" | "SAT_PRICE_STEP" | "BTCPAY_BASE_URL" | "BTCPAY_STORE_ID" | "BILLING_RETURN_URL" | "ADMIN_CONSOLE_ENABLED" | "AUTH_HMAC_KEY" | "VENICE_API_KEY" | "ADMIN_ALLOWED_USERNAMES" | "TEST_WALLET_FAUCET_XPUB">> {}
}
