...
const s = StyleSheet.create({
  ...
  label: { fontFamily: typography.pixel, fontSize: 11, letterSpacing: 2 },
  hint: { fontFamily: typography.pixel, fontSize: 7, textAlign: 'center', lineHeight: 14, letterSpacing: 1 },
});
